<!-- AUTO-GENERATED by agent-skills sync. Do not edit. Source: skills/nitropush-rn-js.md -->
---
...
trigger: glob
globs: packages/react-native/src/**, apps/expo-example/**/*.{ts,tsx,js,jsx}, apps/react-native-example/**/*.{ts,tsx,js,jsx}
---
